          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="http://localhost/ProjetoWeb/Controlador" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="number" name="valor" class="form-control" id="inputVALOR" placeholder="Valor">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <input type="url" name="site" class="form-control" id="inputSITE" placeholder="Site">
                </div>
              </div>
