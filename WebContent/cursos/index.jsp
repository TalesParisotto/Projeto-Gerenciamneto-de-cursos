        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <div class="col-md-12  btn-group btn-group-lg btn-group-vertical">
              <a href="../Controlador?idformulario=2&tipoformulario=21" class="btn btn-default">Consultar Todos os Cursos</a>
               <a href="consulta.jsp" class="btn btn-default">Consultar todos os Clientes</a>
